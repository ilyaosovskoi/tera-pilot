...
(function () {
  ...
  function detectRoute(method) {
    ...
    var POST_ROUTES = {
      ...
      'write_claude_md':       '/api/memory/write',
      'append_claude_lesson':  '/api/memory/append_lesson',
      ...
      if (route.verb === 'GET') {
        ...
        if (args.length === 1 && args[0] && typeof args[0] === 'object' && !Array.isArray(args[0])) {
          ...
          var POST_ARG_MAP = {
            ...
            'save_memory': ['chat_id', 'title', 'summary'],
            'save_snippet': ['name', 'content', 'language'],
            'delete_snippet': ['name'],
            'toggle_auto_router': ['enabled'],
